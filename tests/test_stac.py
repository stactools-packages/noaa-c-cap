...
from stactools.noaa_c_cap.constants import CLASSIFICATION_CLASSES, COLLECTION_CITATION
...
class StacTest(unittest.TestCase):
    def test_create_collection(self):
        hrefs = [
            test_data.get_external_data("conus_2016_ccap_landcover_20200311.tif"),
        ...
        with TemporaryDirectory() as directory:
            collection.normalize_hrefs(os.path.join(directory, "collection.json"))
            collection.validate_all()

    def test_create_item(self):
        path = test_data.get_external_data("conus_2016_ccap_landcover_20200311.tif")
